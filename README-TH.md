...
Collector รับได้ทั้งข้อความที่ผู้อื่นส่งเข้ามาและข้อความที่บัญชี userbot ส่งเอง จึงสามารถทดสอบด้วยการส่งลิงก์เป้าหมายจากบัญชีเดียวกันได้ ผลลัพธ์จะถูกส่งไปยัง Saved Messages (`me`) ตามค่าเริ่มต้น
